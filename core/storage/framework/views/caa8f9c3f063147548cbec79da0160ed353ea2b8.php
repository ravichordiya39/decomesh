...
<?php $__env->startSection('content'); ?>
    <div class="padding p-b-0">
        ...
        <?php if(@Auth::user()->permissionsGroup->home_status): ?>
            <?php if(strip_tags(@Auth::user()->permissionsGroup->{'home_details_'. @Helper::currentLanguage()->code}) !=""): ?>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="box p-a">
		                  ...
		                  <span><?php echo e($v1); ?></span>
                                                ...
                                                <div class="list-body">
                                                    ...
                                                    <small class="text-muted text-ellipsis">
                                                        <?php echo e(__('backend.visitors')); ?> : <?php echo e($v2); ?>,
                                                        <?php echo e(__('backend.pageViews')); ?> : <?php echo e($v3); ?>
...
<?php echo $__env->make('dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/decomesh/public_html/core/resources/views/dashboard/home.blade.php ENDPATH**/ ?>