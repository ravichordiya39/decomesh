...
<footer class="u-align-center u-clearfix u-footer u-grey-80 u-footer container-fluid" id="sec-aafe" >
 ...
 <p class="text-left">
     ...
     <a class="" style="text-decoration:none" href="<?php echo e(URL::to('/')); ?>/about">About</a></br>
<a class="" href="<?php echo e(URL::to('/')); ?>/solutions">Solutions</a></br>
<a class="" href="<?php echo e(URL::to('/')); ?>/contact">Contact</a></br>
...
function showAll(){
   // alert('Would you like to Clear!');   
	...
	var selectProducted = selected;
	
	$("#message").val(selectProducted);
	$("input[name=product_ids]:hidden").val(selected);
	$("input[name=_token]:hidden").val('<?php echo csrf_token();?>');
	$("#myModal").modal();
	...
	$('#ProductSubmited').click(function() {
    
	var prod_ids = $("input[name=product_ids]").val();
	var token_val = $("input[name=_token]").val();
		...
		var strData = 'id='+prod_ids+'&_token='+token_val+'&name='+$("#name").val()+'&emailaddress='+$("#emailaddress").val()+'&phone_no='+$("#phone_no").val()+'&message='+$("#message").val();
		
		
	
		var xhr = $.ajax({
						type: "POST",
						url: "<?php echo e(route("DesignPageSubmit")); ?>",
					   data:strData,
						success: function (data) {
							$("#ProductSubmited").hide();
							 $("#msg").html(data.msg);
...
<script src="<?php echo e(URL::asset('assets/frontend/js/jquery.js')); ?>"></script>



<script src="<?php echo e(URL::asset('assets/frontend/js/jquery-3.6.0.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/frontend/js/jquery.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/frontend/js/jquery.easing.1.3.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/frontend/js/bootstrap.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/frontend/js/jquery.fancybox.pack.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/frontend/js/jquery.fancybox-media.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/frontend/js/google-code-prettify/prettify.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/frontend/js/portfolio/jquery.quicksand.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/frontend/js/portfolio/setting.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/frontend/js/animate.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/frontend/js/custom.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/frontend/js/owl-carousel/owl.carousel.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/frontend/js/Chart.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/frontend/js/nicepage.js')); ?>"></script>




<script src="<?php echo e(URL::asset('assets/frontend/js/jquery.flexslider.js')); ?>"></script>


 
 
<?php /**PATH /home/decomesh/public_html/core/resources/views/frontEnd/includes/footer.blade.php ENDPATH**/ ?>