...
<div class="tab-pane <?php echo e(( Session::get('active_tab') == 'languageSettingsTab') ? 'active' : ''); ?>"
    ...
    <div class="p-a-md col-md-12">
        ...
        <div class="m-t-2">
            <h5><?php echo e(__('backend.languages')); ?></h5>
            <div class="box">
                <table class="table table-striped b-t">
                    <thead class="dker">
                    <tr>
                        <th><?php echo e(__('backend.languageTitle')); ?></th>
            ...
            <a class="btn info " target="_blank"
               href="<?php echo e(url(env('BACKEND_PATH').'/webmaster/translations')); ?>">
...
<?php /**PATH /home/decomesh/public_html/core/resources/views/dashboard/webmaster/settings/language.blade.php ENDPATH**/ ?>