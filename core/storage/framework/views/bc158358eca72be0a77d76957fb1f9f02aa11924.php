                  ...
                  <div class="u-container-style u-layout-cell u-right-cell u-size-20 u-layout-cell-2">
                    <div class="u-container-layout u-valign-top-lg u-valign-top-md u-valign-top-xl u-container-layout-2">
					 ...
					 <div id="sendmessage"><i class="fa fa-check-circle"></i>
                        &nbsp;<?php echo e(__('frontend.youMessageSent')); ?></div>
                  ...
                  <div class="u-container-style u-layout-cell u-right-cell u-size-40 u-layout-cell-3">
                    <div class="u-container-layout u-container-layout-3">
                       <div class="u-form u-form-1">
						  ...
						  <?php echo e(Form::open(['route'=>['contactPage'],'method'=>'POST','class'=>'contactForm u-clearfix u-form-spacing-10 u-form-vertical u-inner-form'])); ?>

                    <div class="form-group u-form-email u-form-group">
					<label for="name-da97" class="u-form-control-hidden u-label">Name</label>
                        <?php echo Form::text('contact_name',@Auth::user()->name, array('placeholder' => __('frontend.yourName'),'class' => 'form-control u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-grey-5 u-input u-input-rectangle','id'=>'name', 'data-msg'=> __('frontend.enterYourName'),'data-rule'=>'minlen:4')); ?>

                        <div class="alert alert-warning validation"></div>
                    </div>
                    <div class="form-group u-form-email u-form-group">
                        <?php echo Form::email('contact_email',@Auth::user()->email, array('placeholder' => __('frontend.yourEmail'),'class' => 'form-control u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-grey-5 u-input u-input-rectangle','id'=>'email', 'data-msg'=> __('frontend.enterYourEmail'),'data-rule'=>'email')); ?>
                    ...
                    <div class="form-group u-form-group u-form-phone u-form-group-3">
					 <label for="phone-90d8" class="u-form-control-hidden u-label">Phone</label>
                        <?php echo Form::text('contact_phone',"", array('placeholder' => __('frontend.phone'),'class' => 'form-control u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-grey-5 u-input u-input-rectangle','id'=>'phone', 'data-msg'=> __('frontend.enterYourPhone'),'data-rule'=>'minlen:4')); ?>
					...
					?>
                        <?php echo Form::textarea('contact_message',$resultValue, array('placeholder' => __('frontend.message'),'class' => 'form-control u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-grey-5 u-input u-input-rectangle','id'=>'message','rows'=>'4', 'cols' => '50', 'data-msg'=> __('frontend.enterYourMessage'),'data-rule'=>'required')); ?>
                    ...
                    <?php endif; ?>
                    <div>
                        <button type="submit" class="btn btn-theme"><?php echo e(__('frontend.sendMessage')); ?></button>
                    </div>
                    <br>
...
<?php echo $__env->make('frontEnd.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/decomesh/public_html/core/resources/views/frontEnd/contact.blade.php ENDPATH**/ ?>