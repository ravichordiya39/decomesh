            ...
            <div class="row">
                <div class="col-lg-{{(count($Categories)>0)? "12":"12"}}">
                    ...
                    <article>
					  ...
					  <div>
					  <?php if($PageTitle!='About Us' && $PageTitle!='Solutions'){?>
                                             <a href="{{ URL::to('contact') }}?enq=<?php echo base64_encode($title);?>" class="pull-left u-black u-btn u-btn-round u-button-style u-hover-grey-75 u-radius-50 u-btn-1">Product Enquiry &nbsp;<i class="fa fa-caret-right"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <a href="{{ URL::to('uploads/topics/16294639994960.jpg') }}" class="pull-left u-black u-btn u-btn-round u-button-style u-hover-grey-75 u-radius-50 u-btn-1" style="margin-left:15px;" download>Download&nbsp;<i class="fa fa-download-right"></i></a>
					  <?php }?>
