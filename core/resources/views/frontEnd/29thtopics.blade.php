...
@section('content')
    ...
    <section id="content">
        ...
        <div class="container">
        <span id="FilterProduct"><input type= "button" id ="showHide" onclick ="showHide()" value="Click to Filter"/></span>
            <div class="row">
                                                        ...
                                                        <h3>
                                                            <!--<a href="{{ $topic_link_url }}"> -->
                                                                @if($Topic->icon !="")
                                                                    <i class="fa {!! $Topic->icon !!} "></i>&nbsp;
                                                                @endif
                                                                 <h4 class="u-text u-text-1"><input class="ads_Checkbox" type="checkbox" id="{{ $Topic->id }}" value="{{ $Topic->id }}"/> {{ $title }} </h4>
                                                           <!-- </a>--></h3>
                                                    </div>
                                                    @if($Topic->photo_file !="")
                                                       <a href="{{ $topic_link_url }}"/> <img src="{{ URL::to('uploads/topics/'.$Topic->photo_file) }}"
                                                             alt="{{ $title }}" style="height:350px !important"/> </a>
                                                    @endif
                                                </div>
                                            @endif
