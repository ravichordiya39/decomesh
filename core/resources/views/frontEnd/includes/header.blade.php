...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="{{URL::to('/')}}/design" style="padding: 10px 10px;">Design</a>
...
</li><li class="u-nav-item"><a class="u-border-active-palette-1-base u-border-hover-palette-1-base u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-90 u-text-hover-palette-2-base" href="{{URL::to('/')}}/contact" style="padding: 10px;">Contact</a>
</li></ul>
        </div>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="{{URL::to('/')}}/design" style="padding: 10px 20px;">Design</a>
